...
public class SimpleShaderProgram extends ShaderProgram {
    ...
    protected void bindAttributes() {
        ...
        GLES20.glBindAttribLocation(shaderProgramHandle, 1, SimpleVertexShader.textureVectorString);
    }
    ...
    public int getTextureHandle() {
        return GLES20.glGetAttribLocation(shaderProgramHandle, SimpleVertexShader.textureVectorString);
    }
     ...
     * @param texBuffer  Contains the texture position
     * @param indexBuffer TODO
     */
    @Override
    public void render(FloatBuffer vertexBuffer, FloatBuffer texBuffer, ByteBuffer indexBuffer) {
        setupShaderUsage();
        ...
        Log.d("SimpleShaderPrograme","glVertexAttribPointer vertexBuffer" + GLUtils.getEGLErrorString(GLES20.glGetError()));
        GLES20.glEnableVertexAttribArray(this.getPositionHandle());
        Log.d("SimpleShaderPrograme","glEnableVertexAttribArray vertexBuffer" + GLUtils.getEGLErrorString(GLES20.glGetError()));
//
...
//         */
        GLES20.glVertexAttribPointer(this.getTextureHandle(), 2, GLES20.GL_FLOAT, true,
                0, texBuffer);
        Log.d("SimpleShaderPrograme","glVertexAttribPointer texBuffer" + GLUtils.getEGLErrorString(GLES20.glGetError()));
        GLES20.glEnableVertexAttribArray(this.getTextureHandle());
        Log.d("SimpleShaderPrograme","glEnableVertexAttribArray texBuffer" + GLUtils.getEGLErrorString(GLES20.glGetError()));
