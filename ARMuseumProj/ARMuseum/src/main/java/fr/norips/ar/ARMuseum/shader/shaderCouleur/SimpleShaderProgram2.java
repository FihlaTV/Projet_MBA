 ...
 */
public class SimpleShaderProgram2 extends ShaderProgram {
     ...
     */
    public SimpleShaderProgram2(OpenGLShader vertexShader, OpenGLShader fragmentShader) {
    ...
    protected void bindAttributes() {
        ...
        GLES20.glBindAttribLocation(shaderProgramHandle, 1, SimpleVertexShader2.colorVectorString);
    }
    ...
    public int getColorHandle() {
        return GLES20.glGetAttribLocation(shaderProgramHandle, SimpleVertexShader2.colorVectorString);
    }
